...
morecure = Spell("MoreCure", 50, 6000, "white")
...
enemy_spells = [fire, meteor, morecure]
    ...
    for enemy in enemies:
        ...
        if enemy_choice == 0:  
            ...
            if spell.type == "white":
                ...
                print(bcolors.OKBLUE + enemy.name.replace(" ", "") + spell.name + " deals " + str(magic_dmg) + " points of damage to " + players[target].name.replace(" ", "") + bcolors.ENDC)
